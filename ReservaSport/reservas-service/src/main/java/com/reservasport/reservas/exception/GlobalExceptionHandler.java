package com.reservasport.reservas.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RecursoRemotoInvalidoException.class)
    public ResponseEntity<Map<String, Object>> manejarRecursoRemotoInvalido(
            RecursoRemotoInvalidoException ex) {
