...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarPromocionNoEncontrada(
            PromocionNoEncontradaException exception
    ) {
    ...
    public ResponseEntity<Map<String, Object>> manejarErrorGeneral(
        ...
        return crearRespuesta(
                ...
                "Ocurrió un error interno en promociones-service"
        );
    }
