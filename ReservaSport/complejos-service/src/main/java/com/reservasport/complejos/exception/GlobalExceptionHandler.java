...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ComplejoNoEncontradoException.class)
    public ResponseEntity<Map<String, Object>> manejarComplejoNoEncontrado(
            ComplejoNoEncontradoException ex) {
    ...
    @ExceptionHandler(NombreComplejoDuplicadoException.class)
    public ResponseEntity<Map<String, Object>> manejarNombreDuplicado(
            NombreComplejoDuplicadoException ex) {
